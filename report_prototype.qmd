...
The NDWI data was last updated on `r most_recent_ndwi_date` (although it may be older than that, need to update the code to log the collection date.)
...
```{r calc_spi, eval = FALSE, fig.width = 10, fig.height = 7, echo = FALSE, warning = FALSE, message = FALSE}
