...
protected_areas_monthly_delta_ndvi <- extract(monthly_delta_ndvi.tif, protected_areas, fun=function(x) quantile(x, probs=c(0, 0.25, 0.5, 0.75, 1.0), na.rm=TRUE), na.rm=T) |> 
  as_tibble() |> 
