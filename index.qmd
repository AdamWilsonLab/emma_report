...
# tar_load(protected_areas)  # Testing
# tar_load(park_fire_history)  # Testing
# tar_load(temp_directory)  # Testing
# tar_load(years_since_fire.tif)  # Testing - temporarily disabled
# tar_load(fires_wgs)  # Testing
# tar_load(most_recent_ndvi.tif)  # Testing - temporarily disabled
# tar_load(most_recent_ndvi_date)  # Testing
# tar_load(monthly_mean_ndvi.tif)  # Testing - temporarily disabled
# tar_load(monthly_delta_ndvi.tif)  # Testing - temporarily disabled
# tar_load(weather_data)  # Testing
