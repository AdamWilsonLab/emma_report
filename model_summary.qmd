...
```{r p1, echo=F, eval=FALSE, warning=F, message=FALSE}
betas=model_results %>% 
  filter(type=="beta")
...
```{r plot, echo=F, eval=FALSE, message=FALSE,fig.height=12}
...
```{r compare_data, echo=F, eval=FALSE, warning=F, message=FALSE}
